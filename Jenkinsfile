...
node("headless-macos") {
  timestamps {
    ...
    def browserPermutations = [
      [ name: "win10Chrome", os: "windows-11", browser: "chrome", buckets: 1 ],
      [ name: "win10FF", os: "windows-11", browser: "firefox", buckets: 1 ],
      [ name: "win10Edge", os: "windows-11", browser: "MicrosoftEdge", buckets: 1 ],
